...
(function(){
  ...
  (function () {
    const translations = {
      ...
      "faq_q2_a": { "en": "The videos you shoot with our app will be saved in your photo album, and you can extract your highlights and share them on social media platforms.", "zh-HK": "透過我們的 App 拍攝後的素材影片會儲存在你相簿，你可以從中剪取你的精華片段發至社交平台。", "zh-CN": "透过我们的 App 拍摄后的素材影片会储存在你相簿，你可以从中剪取你的精华片段发至社交平台。" },
