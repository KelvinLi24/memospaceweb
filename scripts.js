...
(function(){
  ...
  (function () {
    const translations = {
      ...
      "achievements_feature_issuer": { "en": "Issued by: The Hong Kong Polytechnic University Department of Computing (PolyU COMP) &amp; iOS Club (Hong Kong Regional Final) / Computer Education Research Association of Chinese Universities (National Final)", "zh-HK": "Issued by: The Hong Kong Polytechnic University Department of Computing (PolyU COMP) &amp; iOS Club (Hong Kong Regional Final) / Computer Education Research Association of Chinese Universities (National Final)", "zh-CN": "Issued by: The Hong Kong Polytechnic University Department of Computing (PolyU COMP) &amp; iOS Club (Hong Kong Regional Final) / Computer Education Research Association of Chinese Universities (National Final)" },
